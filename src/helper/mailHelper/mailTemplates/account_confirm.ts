export const confirmAccountTemplate = (confirmAccountLink: string) => {
  return `<!DOCTYPE html>
  <html>
    <head>
      <meta charset="utf-8" />
    ...
    <body style="background-color: #e9ecef">
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            >
              ...
              <tr>
                ...
                >
                  <p style="margin: 0">
                    ...
                    <a href="https://ssovee.com/">SSOVEE</a>, you can safely
                    delete this email.
                  </p>
                </td>
              </tr>
              ...
              <tr>
                ...
                >
                  ...
                  <p style="margin: 0">
                    <a href="${confirmAccountLink}" target="_blank">${confirmAccountLink}</a>
                  </p>
                </td>
              </tr>
        ...
        <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
          <p style="margin: 20;">
          Copyright © <script>new Date()</script><a href="https://ssovee.com/" target="_blank">SSOVEE</a>
          </p>
        </td>
      </tr>
        <!-- end footer -->
